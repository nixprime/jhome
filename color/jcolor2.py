...
# palette is the palette of named colors used by our color scheme.
# Usage:
...
# - All hues are designed for use on all "black" background variants.
palette = {
...
if __name__ == "__main__":
    ...
    argp_palette = argsp.add_parser("palette", help="print palette colors")
    argp_seq = argsp.add_parser("seq", help="print sequential colors")
    argp_seq.add_argument("colors", type=int, help="number of colors")
    ...
    elif args.subcmd == "palette":
            for key, color in palette.items():
                print(key, color)

    elif args.subcmd == "seq":
